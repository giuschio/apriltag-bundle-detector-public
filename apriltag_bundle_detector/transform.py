...
class Transform(object):
    ...
    def as_components(self):
        """Represent as translation and rotation components."""
    ...
    def apply(self, point):
        """Alias for compatibility with scipy.spatial.transform.RigidTransform."""
    ...
    def from_components(cls, translation, rotation):
        """Initialize from translation and rotation components."""
        return cls(rotation, translation)
    
    @classmethod
    def from_6dofs(cls, pose_6d, degrees=True):
        """Initialize from a 6-DoF pose in the grasp frame: [t_x, t_y, t_z, r_x, r_y, r_z].
        Rotations are in degrees unless specified otherwise.
        """
        translation = pose_6d[:3]
        rot = pose_6d[3:]
        rotation = Rotation.from_euler('xyz', rot, degrees=degrees)
        return cls(rotation, translation)
